...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#"><i class="bi bi-piggy-bank"></i>KuantoGanha.pt</a>
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="mainContent">
        ...
        if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
            include 'ext/dashboard.php';
        } else {
            include 'ext/welcome.php';
        }
        ?>
    </main>
  </div>
